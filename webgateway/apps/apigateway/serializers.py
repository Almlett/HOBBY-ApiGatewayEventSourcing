...
class EndPointSerializer(serializers.ModelSerializer):
    ...
    class Meta: 	# pylint: disable=too-few-public-methods
        """
        Select all fields from model EndPoint
        """
...
class ApiSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        """Save instance an autogenerate permissions
        ...
        for item in TYPE_CHOICE_LIST:
            ...
            permission.name = "{} | {} | {}".format(
                item_type, instance.origin.name, instance.api_path)
            permission.key = "{}{}{}".format(
                item_type.lower(), instance.origin.host, instance.api_path)
            permission.description = "Autogenerate permission type {} for {} from {}:{}".format(
                item_type, instance.api_path, instance.origin.name, instance.origin.port)
